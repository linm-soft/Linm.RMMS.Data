# Demo control-map (modern MFE) — `incident`
...
| hattruongchidao | text | content | Text | TextField · common-field-control |
| mucdonghiemtrong | text | content | Text | TextField · common-field-control |
| mota | text | content | TextArea | TextField multiline |
| huongxuly | text | content | Text | TextField · common-field-control |
| loaiTaiSan | text | content | Text | TextField · common-field-control |
| trangthaibaocao | text | content | Text | TextField · common-field-control |
| textfield-1087-inputEl | text | toolbar | Text | TextField · common-field-control |
...
| combo-1311-inputEl | text | content | Text | TextField · common-field-control |
| textfield-1312-inputEl | text | content | Text | TextField · common-field-control |
| numberfield-1313-inputEl | text | content | Text | TextField · common-field-control |
| numberfield-1314-inputEl | text | content | Text | TextField · common-field-control |
| numberfield-1315-inputEl | text | content | Text | TextField · common-field-control |
| numberfield-1316-inputEl | text | content | Text | TextField · common-field-control |
...
| numberfield-1330-inputEl | text | content | Text | TextField · common-field-control |
| numberfield-1331-inputEl | text | content | Text | TextField · common-field-control |
| numberfield-1332-inputEl | text | content | Lookup ĐT | SearchInput · form-catalog-lookup-input |
| numberfield-1333-inputEl | text | content | Lookup ĐT | SearchInput · form-catalog-lookup-input |
| numberfield-1334-inputEl | text | content | Text | TextField · common-field-control |
...
| numberfield-1342-inputEl | text | content | Text | TextField · common-field-control |
| numberfield-1343-inputEl | text | content | Text | TextField · common-field-control |
| numberfield-1344-inputEl | text | content | Text | TextField · common-field-control |
| numberfield-1345-inputEl | text | content | Text | TextField · common-field-control |
| textfield-1346-inputEl | text | content | Text | TextField · common-field-control |
...
| Thêm CV | create | toolbar | Tạo mới / Thêm | Button primary · catalog/voucher toolbar |
| Xem CV | view | toolbar | Xem | Button/link · View mode · fieldLockProps |
| Xem | view | toolbar | Xem | Button/link · View mode · fieldLockProps |
| Xóa | destructive | toolbar | Xóa / Hủy | Button danger · Confirm modal |
...
| Xuất sổ NKTĐ theo vấn đề | export | grid | Xuất Excel | export-excel · toolbar |
| Xuất sổ NK tuần đường | export | grid | Xuất Excel | export-excel · toolbar |
| Xuất NK tuần kiểm | export | grid | Xuất Excel | export-excel · toolbar |
| Xuất tất cả NK Tuần kiểm | export | grid | Xuất Excel | export-excel · toolbar |
| Xuất nhật ký tuần đèn | export | grid | Xuất Excel | export-excel · toolbar |
| Xuất nhật ký tuần đường đô thị | export | grid | Xuất Excel | export-excel · toolbar |
| Xuất bảng tổng hợp | export | grid | Xuất Excel | export-excel · toolbar |
...
- Capture raw: `_raw/legacy-govone/features/incident.md`
