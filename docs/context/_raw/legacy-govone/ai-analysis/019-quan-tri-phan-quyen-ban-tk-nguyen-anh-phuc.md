...
| **screenshot** | `screenshots/019-quan-tri-phan-quyen-ban-tk-nguyen-anh-phuc.png` |
| **DOM fields** | 1 |
| **DOM labels** | 1 |
| **DOM buttons** | 5 |
...
> Vision reviewed: 2026-08-02 · ai-autocode autopilot · screenshot `019-quan-tri-phan-quyen-ban-tk-nguyen-anh-phuc.png`
...
Twin gần trùng: `017-quan-tri-phan-quyen-ban-tk-nguyen-anh-phuc` (cùng slug/URL · menu mở · 5 actions).  
...
**Primary — User menu mở trên Danh mục đoạn đường `019`**
...
- Twin: `017` · Upstream root: `006`/`016`/`018` · Downstream: `020`
...
- Bell thông báo
- **Ban.TK.Nguyễn Anh Phúc** (user menu trigger — **mở** trên `019`)
...
- Section: `## Legacy GOVOne (auto-capture)` → capture id `019-quan-tri-phan-quyen-ban-tk-nguyen-anh-phuc`
...
- Sibling: `006`/`016`/`018` (root menu đóng) · `017` (twin menu mở) · `020` (đổi mật khẩu)
