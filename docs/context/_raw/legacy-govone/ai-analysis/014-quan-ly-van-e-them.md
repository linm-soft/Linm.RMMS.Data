...
| | |
|---|---|
| **id** | `014-quan-ly-van-e-them` |
| **slug** | `incident` |
| **url** | https://pmdb.govone.vn/dbv3baotri.aspx#panelVanDe |
| **screenshot** | `screenshots/014-quan-ly-van-e-them.png` |
| **DOM fields** | 144 |
| **DOM labels** | 141 |
| **DOM buttons** | 29 |
...
| input | text | combo-1115-inputEl |
| input | text | combo-1116-inputEl |
| input | text | combo-1117-inputEl |
| input | text | textfield-1118-inputEl |
| input | text | datefield-1119-inputEl |
| input | text | textfield-1120-inputEl |
| input | text | textfield-1122-inputEl |
| input | text | textfield-1124-inputEl |
| input | text | combo-1125-inputEl |
| input | text | combo-1126-inputEl |
| input | text | combo-1127-inputEl |
| input | text | combo-1128-inputEl |
| input | text | datefield-1129-inputEl |
| input | text | datefield-1130-inputEl |
| input | text | combo-1131-inputEl |
| input | text | datefield-1132-inputEl |
| input | text | textfield-1133-inputEl |
| input | text | textfield-1134-inputEl |
| input | text | combo-1135-inputEl |
