...
| **screenshot** | `screenshots/018-quan-tri-phan-quyen.png` |
| **DOM fields** | 1 |
| **DOM labels** | 1 |
| **DOM buttons** | 2 |
...
> Vision reviewed: 2026-08-02 · ai-autocode autopilot · screenshot `018-quan-tri-phan-quyen.png`
...
Twin capture gần trùng: `006-quan-tri-phan-quyen` · `016-quan-tri-phan-quyen` (cùng URL/slug · user menu đóng · 2 actions DOM).  
...
**Primary — Danh mục đoạn đường `018` (root view)**
...
- Bell thông báo
- **Ban.TK.Nguyễn Anh Phúc** (user menu trigger — đóng trên `018`)
...
User menu mở (`017`/`019`: Hồ sơ của tôi · Đổi mật khẩu · Đăng xuất) · Đổi mật khẩu form (`020`: MK cũ · MK mới · Xác nhận · submit · VỀ TRANG CHỦ) · twin root `006`/`016` — giữ trong `users-actions.md` / control-map. **Không** bịa thêm button không có trên ảnh/DOM.

### Map → step context

- Feature: `docs/context/features/users.md`
- Section: `## Legacy GOVOne (auto-capture)` → capture id `018-quan-tri-phan-quyen`
...
- Twin: `006`/`016` (cùng slug/URL root) · sibling `017`/`019` (user menu) · `020` (đổi mật khẩu)
