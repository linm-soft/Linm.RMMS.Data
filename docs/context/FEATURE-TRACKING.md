...
> **Cập nhật:** 2026-09-19 · seed SĐT VN rewrite `cuc01_staff.csv` + `app_users.csv` (59 hàng · `0976258792`) — **không** queue · [users](features/users.md) §4b  
...
| `job-title` | Danh mục chức vụ `/mas/chuc-vu` | — | support | `data_analy` / `pending` | none | [ctx](features/job-title.md) | [ST](../../specs/job-title/STATUS.md) |
...
| `so-ts-type-grid` | Sổ TS grid/form theo loại | 01 | P1-900 | `data_analy` / `pending` | none | [ctx](features/so-ts-type-grid.md) | [ST](../../specs/so-ts-type-grid/STATUS.md) |
...
| `incident-list` | [Mobile] Vấn đề | — | support | `done` / `done` | none | [ctx](features/incident-list.md) | [ST](../../specs/incident-list/STATUS.md) |
...
| `rpt-nhat-ky-tuan-duong` | rpt-nhat-ky-tuan-duong | — | support | `qa` / `in_progress` | none | [ctx](features/rpt-nhat-ky-tuan-duong.md) | [ST](../../specs/rpt-nhat-ky-tuan-duong/STATUS.md) |
...
| support | `map-service` · `gis-osm-clip` · `directions` · `legal-tech-corridor` · `ios-store-submit` · `toc` | `map-service` Wave 1–4 **web done** · Wave 2–4 **mobile done** (ios+android gis-map clip) · `ios-store-submit` context/live |
...
`map-service` · `gis-osm-clip` · `legal-tech-corridor` · `ios-store-submit` · `directions` — skill `/implement-map-stack` · `/implement-map-service` · `/implement-gis-map` · `/review-app-vn-map-law` · `/fill-build-ios-info` · `/implement-directions-app`.
...
| Next | Lab radar **Fused** (Calibration) trước khi coi ingest speed bug · tắt Multi-Way · QA ingest 401/403/429 — [31](31-CAMERA-TCM403-LAB-RADAR.md) · [23](23-CAMERA-HOST-NOTIFY-CONFIG.md) |
| Ref | [`camera-model.md`](camera-model.md) · [`features/camera-vehicle-type.md`](features/camera-vehicle-type.md) · [`21-CAMERA-HLS-WEBRTC-GATEWAY.md`](21-CAMERA-HLS-WEBRTC-GATEWAY.md) · [`22-CAMERA-TCM403-SDK-RESEARCH.md`](22-CAMERA-TCM403-SDK-RESEARCH.md) · [`31-CAMERA-TCM403-LAB-RADAR.md`](31-CAMERA-TCM403-LAB-RADAR.md) · [`28-CAMERA-SECURITY.md`](28-CAMERA-SECURITY.md) · [`23-CAMERA-HOST-NOTIFY-CONFIG.md`](23-CAMERA-HOST-NOTIFY-CONFIG.md) |
...
| D6 | Camera wall + map | `gis-camera-map` | `/gis/camera` :9302 | Camera mock P1 · peer `camera-connect` | Dev STATUS · **không** enqueue lại |
