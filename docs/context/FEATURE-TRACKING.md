...
> **Cập nhật:** 2026-09-16 · queue `qlbd-mobile` `task_1f6d86c4` `/implement-gis-map` `ios_replace_all_maps` (`patrol-map` + HITL `photo-geo-capture`) · /hey-linm `autocode_hub` · skill **`/gen-feature-tracking`**.  
> **Prior:** 2026-09-12 · `photo-geo-capture` · 2026-09-05 web map/camera/CSDL.  
...
| support | `map-service` · `gis-osm-clip` · `directions` · `legal-tech-corridor` · `toc` | `map-service` Wave 1–4 **web done** · Wave 2–4 **mobile done** (ios+android gis-map clip) |
