...
> **Slug:** `so-ts-pontoon` · **type:** `PONTOON` · **cluster:** `crossing` · ô `t05`  
> **Parent SSOT:** [`so-ts-type-grid.md`](so-ts-type-grid.md) · fields [`import-gov-asset-fields.md`](import-gov-asset-fields.md)  
> **Mẫu:** `docs/img/gov-mau-tai-san/2-tbl_pontoon_bridge-list.png` · `2-tbl_pontoon_bridge-detail.png`  
> **Route:** `/so-ts?type=PONTOON` · form `/so-ts/tao-moi` · `/so-ts/sua?id=`  
