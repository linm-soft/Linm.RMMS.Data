...
- [x] Tạo từ Sự cố
- [x] Badge «P2: nghiệm thu / SLA full» · AI estimate → P2
- [x] KPI + biểu đồ bảo trì
- [x] Đủ 69 actions từ control-map (catalog clickable)
- [x] Leave-confirm khi WO dirty
- [x] Không gọi BE
- [x] Bảng tổng hợp nhanh (014) · metric + tree Company→QL→Km
- [x] sourceKind=legacy · chrome GOVOne skip
- [x] Dev menu · demoCatalog · /dev voucher group
- [x] features/maintenance-demo.html redirect
...
- **id:** `002-sua-chua-inh-ky`
- **capture:** `capture/maintenance/root/view/` (master/page/action)
...
- **id:** `003-sua-chua-inh-ky-bang-tong-hop-nhanh`
- **capture:** `capture/maintenance/bang-tong-hop-nhanh/view/` (master/page/action)
...
| | |
|--|--|
| Task | `task_7c729e4a` (prior `task_56b50f4d`) |
| Skill | `/qlbd-analy-demo @maintenance` |
| sourceKind | `legacy` |
| Files | `maintenance.md` · `demo-maps/maintenance-*.md` · `src/demo/maintenance/*` · `public/demo/maintenance/*` · `demoCatalog.ts` · `features/maintenance-demo.html` redirect |
| BE align | OFF (demo · Status Demo) · GAP-F-MNT-03 documented · Step 4b khi Signed |
| RECAPTURE | P0 open in `RECAPTURE-GAPS.md` (WO form-sample shallow) — demo WO suy luận guide · gap open (legacy P0) |
