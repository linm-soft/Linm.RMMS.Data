# Tình trạng mặt đường — Feature Context

> **Slug:** `rpt-tinh-trang-mat-duong` · **Module:** `Report` · **Phase:** P2 · **Wave:** C  
> **Status:** Context  
> **Kind:** **E** (report) — `/erp-report-context` · AnalyticsReportShell  
> **Sources:** GOVOne › Tình trạng mặt đường · pavement-section · hub [reports.md](reports.md) · [15-SCREEN-AI-MAP.md](../15-SCREEN-AI-MAP.md)  
> **Parent / list pack:** `pavement-section` — **cấm** copy CRUD vào trang này  
> **MFE:** `Linm.Web.RMMS.Report` · route `/bao-cao/tinh-trang-mat-duong` · mfeStdUrl `http://localhost:9311/bao-cao/tinh-trang-mat-duong`  
...
| Align MFE | http://localhost:9311/bao-cao/tinh-trang-mat-duong |
...
**Mock:** 8–15 dòng mẫu từ domain PavementSection + PCI history.

Không form Biểu 1. Chart PCI optional P2.
...
| Method | Path | Mô tả |
|--------|------|-------|
| GET | /api/v1/reports/pavement-condition?from=&to=&routeId=&q= | Xem báo cáo (paged) |
| GET | /api/v1/reports/pavement-condition/export | Excel |

Query đọc PavementSection + PCI history — không bảng báo cáo riêng bắt buộc P1 (read-model P2 nếu nặng).

Auth: JWT · tenant · perm `report.tinh-trang-mat-duong.read`.

## 4. Database

Read-model / view trên entity nguồn (PavementSection + PCI history). Index theo filter UI (tuyến · ngày · tenant).
...
| ID | Default |
|----|---------|
| GAP-F-RPT-LEAF-01 Tách khỏi hub `reports` | Leaf slug + route /bao-cao/tinh-trang-mat-duong |
