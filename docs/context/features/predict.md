...
| | |
|--|--|
| Mục tiêu | Dự báo xuống cấp · tuổi thọ còn lại · ưu tiên đại tu/đầu tư từ lưu lượng, thời tiết, vật liệu, tuổi, lịch sử SC |
| Persona | Ban QLDA · kế hoạch bảo trì |
| App hiện có | — (mới; gắn Web Báo cáo / Dashboard) |
| DoD P1 | Priority list online LLM · không train XGBoost |
| DoD P2 | Feature store + XGBoost→ONNX→ML.NET |
...
|--------|-------------|-------|
| SectionFeatures | SectionId, Traffic, Material, Age, WeatherAgg | Feature store |
| PredictionAudit | SectionId, Score, Model, At, RawJson | |

## 5. Events / tích hợp

| Event | Publisher | Consumer |
|-------|-----------|----------|
| `predict.updated` | Predict | Dashboard · Copilot tools |
