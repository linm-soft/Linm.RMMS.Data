...
> **Demo:** `Linm.RMMS.Demo/docs/features/pavement-section-list.html`  
...
| **Confirm** | Auto (docs hồ sơ) — user có thể đổi sang Slideout nếu muốn |
...
| Zone | Control |
|------|---------|
| Header | Title «Phân loại mặt đường» · help |
| Toolbar | Tạo mới · Import · Export · Làm mới · Cấu hình cột |
| Filter | SearchText · Tỉnh · Tên đường · Từ Km–Đến Km · Tình trạng · nút Tìm |
| Grid | STT · Mã · Đường · Tỉnh · KmFrom–To · Kết cấu · Cấp · Tình trạng · ĐV QL · menu hàng |
| Pagination | pageSize 20/50 |

### Form Full page

| Section | Fields |
|---------|--------|
| Header compact (mặc định full) | Mã · Tên đường · Tỉnh · KmFrom · KmTo |
...
- [ ] List filter + grid cột Biểu 1
- [ ] Form full đủ field bắt buộc
- [ ] Mã MD-* hiển thị (mock generate)
- [ ] Lưu local / mock API payload JSON
- [ ] Link mở bản đồ live vẽ đoạn
