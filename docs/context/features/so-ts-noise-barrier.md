...
> **Slug:** `so-ts-noise-barrier` · **type:** `NOISE_BARRIER` · **cluster:** `linear_protect` · ô `t25`  
> **Parent SSOT:** [`so-ts-type-grid.md`](so-ts-type-grid.md) · fields [`import-gov-asset-fields.md`](import-gov-asset-fields.md)  
> **Mẫu:** `docs/img/gov-mau-tai-san/7-tbl_noise_barrier-list.png` · `7-tbl_noise_barrier-detail.png`  
> **Route:** `/so-ts?type=NOISE_BARRIER` · form `/so-ts/tao-moi` · `/so-ts/sua?id=`  
...
|------|-------|--------|-----------|
| web | `done` | `done` | `2026-09-01T10:11:20.402Z` |
| mobile | — | — | — |
