# Sổ TS — Trạm dừng nghỉ

> **Slug:** `so-ts-rest-area` · **type:** `REST_AREA` · **cluster:** `station` · ô `t26`  
...
> **Route:** `/so-ts?type=REST_AREA` · form `/so-ts/tao-moi` · `/so-ts/sua?id=`  
...
|------|-------|--------|-----------|
| web | `done` | `done` | `2026-09-01T04:29:50.020Z` |
| mobile | — | — | — |
