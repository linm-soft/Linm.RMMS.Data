# Báo cáo công — Feature Context

> **Slug:** `rpt-bao-cao-cong` · **Module:** `Report` · **Phase:** P1.5 · **Wave:** B  
> **Status:** Context  
> **Kind:** **E** (report) — `/erp-report-context` · AnalyticsReportShell  
> **Sources:** attendance.md Kind E · GET /attendance/report MISSING · hub [reports.md](reports.md) · [15-SCREEN-AI-MAP.md](../15-SCREEN-AI-MAP.md)  
> **Parent / list pack:** `attendance` — **cấm** copy CRUD vào trang này  
> **MFE:** `Linm.Web.RMMS.Report` · route `/bao-cao/bao-cao-cong` · mfeStdUrl `http://localhost:9311/bao-cao/bao-cao-cong`  
...
| Align MFE | http://localhost:9311/bao-cao/bao-cao-cong |
...
**Filter:** kỳ tuần/tháng · tuyến · user · zone  
...
**Mock:** 8–15 dòng mẫu từ domain AttendanceLog · Check-in.
...
| Method | Path | Mô tả |
|--------|------|-------|
| GET | /api/v1/attendance/report?from=&to=&routeId=&q= | Xem báo cáo (paged) |
| GET | /api/v1/attendance/report/export | Excel |

Query đọc AttendanceLog · Check-in — không bảng báo cáo riêng bắt buộc P1 (read-model P2 nếu nặng).

Auth: JWT · tenant · perm `report.bao-cao-cong.read`.

## 4. Database

Read-model / view trên entity nguồn (AttendanceLog · Check-in). Index theo filter UI (tuyến · ngày · tenant).
...
| ID | Default |
|----|---------|
| GAP-F-RPT-LEAF-01 Tách khỏi hub `reports` | Leaf slug + route /bao-cao/bao-cao-cong |
