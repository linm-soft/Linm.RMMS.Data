...
> **Mẫu:** `docs/img/gov-mau-tai-san/34-moc_dbvn.tbl_spill_way-list.png` · `34-moc_dbvn.tbl_spill_way-detail.png`  
> **Route:** `/so-ts?type=SPILLWAY` · form `/so-ts/tao-moi` · `/so-ts/sua?id=`  
