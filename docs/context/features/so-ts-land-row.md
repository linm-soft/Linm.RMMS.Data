# Sổ TS — Đất thuộc TS HT

> **Slug:** `so-ts-land-row` · **type:** `LAND_ROW` · **cluster:** `land` · ô `t33`  
> **Parent SSOT:** [`so-ts-type-grid.md`](so-ts-type-grid.md) · fields [`import-gov-asset-fields.md`](import-gov-asset-fields.md)  
> **Mẫu:** `docs/img/gov-mau-tai-san/9-tbl_land_btra-list.png` · `9-tbl_land_btra-detail.png`  
> **Route:** `/so-ts?type=LAND_ROW` · form `/so-ts/tao-moi` · `/so-ts/sua?id=`  
...
|------|-------|--------|-----------|
| web | `done` | `done` | `2026-09-01T09:04:41.461Z` |
| mobile | — | — | — |
