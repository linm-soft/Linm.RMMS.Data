...
| 2s | `map-service` | MapService — gis.vn + clip OSM | Platform | P1 | Host `Linm.Platform.MapService` `:5021` · Wave 1–4 **web done** · Wave 2–4 **mobile done** · OSM Carto muted | Context | [map-service.md](map-service.md) · skill `/implement-map-stack` |
...
| 2u-a | `android-store-submit` | Android AAB / CH Play listing | Compliance | P1 | lab `org.linmsoft.rmms` · **chưa** AAB Store | Context | [android-store-submit.md](android-store-submit.md) · [`ANDROID-SUBMIT-GUIDE.md`](../../plan/release-mobile/store/ANDROID-SUBMIT-GUIDE.md) · [`ANDROID-STUDIO-RELEASE.md`](../../plan/release-mobile/store/ANDROID-STUDIO-RELEASE.md) |
...
| 3e | `camera-connect` | Kết nối camera ITS / **HĐ `camera-gtvt`** (PL01 03c · gói C) | **Camera** | P1 Demo / P2 HLS / **G3 5G publish** | Seed **iDS-TCM403-GIR** · live **HLS fMP4** · tủ 5G RTSP publish | Demo | [camera-connect.md](camera-connect.md) · [../camera-model.md](../camera-model.md) · map loại [camera-vehicle-type.md](camera-vehicle-type.md) · **5G** [../32-CAMERA-RTSP-PUBLISH-INGEST.md](../32-CAMERA-RTSP-PUBLISH-INGEST.md) · alias HĐ=`camera-gtvt` · **pilot wall+map** [camera-ops-dashboard-demo.html](../../../Linm.RMMS.Demo/src/demo/features/camera-ops-dashboard-demo.html) |
...
| 4n | `nghiem-thu` | Công tác nghiệm thu (clone tuần kiểm + 10 mẫu) | Field | P1 | Web done · mobile `pending_confirm` | Demo | [nghiem-thu.md](nghiem-thu.md) |
| 4n1 | `nghiem-thu-create` | Tạo nghiệm thu (mobile sheet) | Field | P1 | scan 19/09 | Draft | [nghiem-thu-create.md](nghiem-thu-create.md) |
| 4n2 | `nghiem-thu-detail` | Chi tiết / Sửa nghiệm thu (mobile) | Field | P1 | plus_detail | Draft | [nghiem-thu-detail.md](nghiem-thu-detail.md) |
