# Sổ TS — CT HTKT trong HL

> **Slug:** `so-ts-row-util` · **type:** `ROW_UTIL` · **cluster:** `land` · ô `t08`  
> **Parent SSOT:** [`so-ts-type-grid.md`](so-ts-type-grid.md) · fields [`import-gov-asset-fields.md`](import-gov-asset-fields.md)  
> **Mẫu:** `docs/img/gov-mau-tai-san/32-moc_dbvn.tbl_infrastructure_row-list.png` · `32-moc_dbvn.tbl_infrastructure_row-detail.png`  
> **Route:** `/so-ts?type=ROW_UTIL` · form `/so-ts/tao-moi` · `/so-ts/sua?id=`  
...
|------|-------|--------|-----------|
| web | `done` | `done` | `2026-09-01T20:17:08.972Z` |
| mobile | — | — | — |
