# Sổ TS — Chiếu sáng đường

> **Slug:** `so-ts-lighting` · **type:** `LIGHTING` · **cluster:** `ops` · ô `t18`  
> **Parent SSOT:** [`so-ts-type-grid.md`](so-ts-type-grid.md) · fields [`import-gov-asset-fields.md`](import-gov-asset-fields.md)  
> **Mẫu:** `docs/img/gov-mau-tai-san/15-moc_dbvn.tbl_street_lighting-list.png` · `15-moc_dbvn.tbl_street_lighting-detail.png`  
> **Route:** `/so-ts?type=LIGHTING` · form `/so-ts/tao-moi` · `/so-ts/sua?id=`  
...
|------|-------|--------|-----------|
| web | `done` | `done` | `2026-09-01T20:48:08.749Z` |
| mobile | — | — | — |
