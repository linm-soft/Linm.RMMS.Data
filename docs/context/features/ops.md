...
| | |
|--|--|
| Mục tiêu | Điều hành tuần tra · sự cố · sửa chữa · theo dõi nhân lực · inbox chỉ đạo + notify |
| Persona | Hạt trưởng · điều phối |
| App hiện có | Mobile/Web **Giám sát** · thông báo trong Vấn đề |
| DoD P1 | Notify + list inbox chỉ đạo (demo) · nav sang Giám sát/map |
| DoD P2 | Command center · điều phối đa đội · thread · SignalR |
...
Consume incident/patrol/workorder · publish push/SignalR (P2). Cross-nav demo → patrol / gis / incident.
