...
> **Slug:** `so-ts-traffic-sign` · **type:** `TRAFFIC_SIGN` · **cluster:** `atgt_point` · ô `t32`  
> **Parent SSOT:** [`so-ts-type-grid.md`](so-ts-type-grid.md) · fields [`import-gov-asset-fields.md`](import-gov-asset-fields.md)  
> **Mẫu:** `docs/img/gov-mau-tai-san/38-moc_dbvn.tbl_road_sign-list.png` · `38-moc_dbvn.tbl_road_sign-detail.png`  
> **Route:** `/so-ts?type=TRAFFIC_SIGN` · form `/so-ts/tao-moi` · `/so-ts/sua?id=`  
...
|------|-------|--------|-----------|
| web | `done` | `done` | `2026-09-01T14:21:23.786Z` |
| mobile | — | — | — |
