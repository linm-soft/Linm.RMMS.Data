...
> **Status:** Demo  
> **Sources:** App hiện có screenshot `docs/1-ban-do.png` (GOVOne · Nghệ An) · `07` §1–§2 · `09` GIS 2D  
> **Demo HTML:** `Linm.RMMS.Demo/docs/features/gis-draw-google-demo.html` (mock screenshot)  
> **Live map (chạy thử):** `Linm.RMMS.Demo/docs/features/gis-draw-live.html` — Leaflet + OSM/Esri · Leaflet.draw  
