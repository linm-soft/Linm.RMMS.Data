...
> **Slug:** `so-ts-median` · **type:** `MEDIAN` · **cluster:** `linear_protect` · ô `t11`  
> **Parent SSOT:** [`so-ts-type-grid.md`](so-ts-type-grid.md) · fields [`import-gov-asset-fields.md`](import-gov-asset-fields.md)  
> **Mẫu:** `docs/img/gov-mau-tai-san/23-moc_dbvn.tbl_median_strip-list.png` · `23-moc_dbvn.tbl_median_strip-detail.png`  
> **Route:** `/so-ts?type=MEDIAN` · form `/so-ts/tao-moi` · `/so-ts/sua?id=`  
...
|------|-------|--------|-----------|
| web | `done` | `done` | `2026-09-01T17:40:47.260Z` |
| mobile | — | — | — |
