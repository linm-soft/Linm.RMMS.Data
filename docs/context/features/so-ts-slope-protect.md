# Sổ TS — Bảo vệ mái dốc

> **Slug:** `so-ts-slope-protect` · **type:** `SLOPE_PROTECT` · **cluster:** `linear_protect` · ô `t12`  
> **Parent SSOT:** [`so-ts-type-grid.md`](so-ts-type-grid.md) · fields [`import-gov-asset-fields.md`](import-gov-asset-fields.md)  
> **Mẫu:** `docs/img/gov-mau-tai-san/33-moc_dbvn.tbl_slope-list.png` · `33-moc_dbvn.tbl_slope-detail.png`  
> **Route:** `/so-ts?type=SLOPE_PROTECT` · form `/so-ts/tao-moi` · `/so-ts/sua?id=`  
