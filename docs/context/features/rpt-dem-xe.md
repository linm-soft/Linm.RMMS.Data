# Đếm xe — Feature Context

> **Slug:** `rpt-dem-xe` · **Module:** `Report` · **Phase:** P2 · **Wave:** C  
> **Status:** Context  
> **Kind:** **E** (report) — `/erp-report-context` · AnalyticsReportShell  
> **Sources:** GOVOne › Đếm xe · csdl sổ 4 · hub [reports.md](reports.md) · [15-SCREEN-AI-MAP.md](../15-SCREEN-AI-MAP.md)  
> **Parent / list pack:** `csdl-so-sach` — **cấm** copy CRUD vào trang này  
> **MFE:** `Linm.Web.RMMS.Report` · route `/bao-cao/dem-xe` · mfeStdUrl `http://localhost:9311/bao-cao/dem-xe`  
...
| Align MFE | http://localhost:9311/bao-cao/dem-xe |
...
**Mock:** 8–15 dòng mẫu từ domain TrafficCountSummary.

Layout cột Excel đúng mẫu B.1/B.2.
...
| Method | Path | Mô tả |
|--------|------|-------|
| GET | /api/v1/reports/traffic-counts?from=&to=&routeId=&q= | Xem báo cáo (paged) |
| GET | /api/v1/reports/traffic-counts/export | Excel |
...
Read-model / view trên entity nguồn (TrafficCountSummary). Index theo filter UI (tuyến · ngày · tenant).
...
| ID | Default |
|----|---------|
| GAP-F-RPT-LEAF-01 Tách khỏi hub `reports` | Leaf slug + route /bao-cao/dem-xe |
