# Nhật ký công việc — Feature Context

> **Slug:** `rpt-nhat-ky-cong-viec` · **Module:** `Report` · **Phase:** P2 · **Wave:** C  
> **Status:** Context  
> **Kind:** **E** (report) — `/erp-report-context` · AnalyticsReportShell  
> **Sources:** GOVOne › Nhật ký công việc · csdl sổ 7 · hub [reports.md](reports.md) · [15-SCREEN-AI-MAP.md](../15-SCREEN-AI-MAP.md)  
> **Parent / list pack:** `maintenance` — **cấm** copy CRUD vào trang này  
> **MFE:** `Linm.Web.RMMS.Report` · route `/bao-cao/nhat-ky-cong-viec` · mfeStdUrl `http://localhost:9311/bao-cao/nhat-ky-cong-viec`  
...
| Align MFE | http://localhost:9311/bao-cao/nhat-ky-cong-viec |
...
**Mock:** 8–15 dòng mẫu từ domain MaintenanceWorkLog.

Khác tổng hợp bảo trì (KPI). Đây là nhật ký dòng việc.
...
| Method | Path | Mô tả |
|--------|------|-------|
| GET | /api/v1/reports/work-logs?from=&to=&routeId=&q= | Xem báo cáo (paged) |
| GET | /api/v1/reports/work-logs/export | Excel |

Query đọc MaintenanceWorkLog — không bảng báo cáo riêng bắt buộc P1 (read-model P2 nếu nặng).

Auth: JWT · tenant · perm `report.nhat-ky-cong-viec.read`.

## 4. Database

Read-model / view trên entity nguồn (MaintenanceWorkLog). Index theo filter UI (tuyến · ngày · tenant).
...
| ID | Default |
|----|---------|
| GAP-F-RPT-LEAF-01 Tách khỏi hub `reports` | Leaf slug + route /bao-cao/nhat-ky-cong-viec |
