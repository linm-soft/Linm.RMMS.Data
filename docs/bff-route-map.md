...
| `ServiceEndpoints:AuthenticationService` | `http://localhost:5001` (Docker `http://host.docker.internal:5001`) |
...
Thiếu proxy path → controller catch-all đã cover · **cấm** app gọi thẳng service.
