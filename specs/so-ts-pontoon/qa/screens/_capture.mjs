...
const aliasUrl = "http://localhost:9301/so-ts-pontoon";
const formUrl = "http://localhost:9301/so-ts/tao-moi?type=PONTOON";
const listSel = '[data-testid="rmms-so-ts-pontoon-list-page"]';
const formSel = '[data-testid="rmms-asset-form-shell"]';
const attrSel = '[data-testid="asset-pontoon-attr"]';
...
const steps = [
  {
    ...
    url: listUrl,
    selector: listSel,
    note: "list PONTOON profile + filter bar",
  },
  {
    id: "S1",
    url: aliasUrl,
    selector: listSel,
    note: "alias /so-ts-pontoon → type=PONTOON",
  },
  {
    id: "QA-20",
    url: formUrl,
    selector: formSel,
    also: attrSel,
    note: "Create form · S-ATTR pontoon",
  },
];
...
const manifest = {
  ...
  testid: "rmms-so-ts-pontoon-list-page",
