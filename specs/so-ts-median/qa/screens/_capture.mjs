/**
 * E2E capture S0/S1/QA-20 — so-ts-median · channel=chrome · no kill :9301
...
const aliasUrl = "http://localhost:9301/so-ts-median";
...
const steps = [
  {
    ...
    note: "list MEDIAN profile + filter bar · kmTo ON · type hidden",
  },
  {
    id: "S1",
    url: aliasUrl,
    selector: `[data-testid="${TEST_ID}-page"]`,
    note: "alias /so-ts-median → Navigate type=MEDIAN",
  },
  {
    id: "QA-20",
    url: formUrl,
    selector: '[data-testid="rmms-asset-form-shell"]',
    note: "Create form · S-ATTR median · S-LOC-RANGE · PC-",
  },
];
