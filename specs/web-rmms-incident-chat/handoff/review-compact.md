...
writtenAt: 2026-09-26T10:01:28.289Z
taskId: task_3eb555c0
...
## Decisions
- formPattern: Mobile chat INC-CHAT · phone ≤430 · LinmChatThread+Composer · #sc-incident-chat · N/A ERP Modal
- mfe: Linm.Web.RMMS.Mobile · mfeStdRoute=/web-rmms-incident-chat · mfeStdUrl http://localhost:9301/web-rmms-incident-chat
- productRoute: /incident/:id/chat → alias STD · entry peer #i-chat
- be: Mobile.Bff :5202 · GET/POST incident/incidents/{id}/messages · GET {id} · init-data opt · cấm ERP.* · Step 4b N/A
...
- T-01…T-06 done · T-QA PASS/WAIVE · T-BE N/A
...
## Full paths
- findings: D:/AI-QLBD/Linm.RMMS.Data/specs/web-rmms-incident-chat/review/findings.md
