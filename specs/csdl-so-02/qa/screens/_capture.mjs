...
const hubRedirectSel = '[data-testid="rmms-csdl-so-02-list-page"]';
...
const steps = [
  {
    ...
    url: listUrl,
    selector: listSel,
    note: "list Sổ 02 · filter-bar · province/status/road/period · empty/grid",
  },
  {
    id: "S1",
    url: hubUrl,
      ...
      if (step.id === "S0") {
        const live = await page.evaluate(() => {
          ...
          return {
            ...
            peerSots: testids.includes("rmms-csdl-so-02-list-peer-sots"),
            peerNoneOk: !testids.includes("rmms-csdl-so-02-list-peer-sots"),
            emptyOrGrid:
              testids.includes("rmms-csdl-so-02-list-empty") ||
