...
| updatedAt | `2026-08-31T18:06:41.959Z` |
## Lock
...
|------|-------|----------|--------|
| 0 | data-analy | _data-analy/features/so-ts-rail-cross-control-hint.md · so-ts-rail-cross-real-data.md | **pending** |
| 1 | po | po/requirement.md | **pending** |
| 2.1 | design | ui/design.md + prototype + reviewUrl | **pending** |
| 2.2 | sa | be/solution-discovery.md | **pending** |
| 3 | team-lead | task/so-ts-rail-cross.md | **pending** |
| 4 | dev | implement/so-ts-rail-cross.md | **pending** |
