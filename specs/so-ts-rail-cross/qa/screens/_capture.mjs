/**
 * E2E capture S0/S1/QA-20 — so-ts-rail-cross · channel=chrome · no kill :9301
...
const aliasUrl = "http://localhost:9301/so-ts-rail-cross";
...
const steps = [
  {
    ...
    note: "list RAIL_CROSS profile + filter bar · type hidden · protection/traffic/waiting cols",
  },
  {
    id: "S1",
    url: aliasUrl,
    selector: `[data-testid="${TEST_ID}-page"]`,
    note: "alias /so-ts-rail-cross → Navigate type=RAIL_CROSS",
  },
  {
    id: "QA-20",
    url: formUrl,
    selector: '[data-testid="rmms-asset-form-shell"]',
    note: "Create form · S-ATTR rail-cross · kmTo hidden · DS-",
  },
];
