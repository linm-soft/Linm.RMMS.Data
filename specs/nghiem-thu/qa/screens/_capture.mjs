...
const cfg = {"url":"http://localhost:9304/nghiem-thu","outDir":"D:\\AI-QLBD\\Linm.RMMS.Data\\specs\\nghiem-thu\\qa\\screens","loginPage":"http://localhost:9100/login","company":"RMMS","headless":false,"pagesWait":null,"testid":"rmms-nghiem-thu-list","steps":[{"id":"S0","action":"goto","selector":"[data-testid=\"rmms-nghiem-thu-list\"]"},{"id":"S1","action":"goto"},{"id":"QA-20","action":"goto"}]};
const results = [];
