...
const cfg = {"url":"http://localhost:9311/bao-cao/nhat-ky-tuan-duong","outDir":"D:\\AI-QLBD\\Linm.RMMS.Data\\specs\\rpt-nhat-ky-tuan-duong\\qa\\screens","loginPage":"http://localhost:9100/login","company":"RMMS","headless":false,"pagesWait":null,"testid":"rmms-patrol-log-road-report-page","steps":[{"id":"S0","action":"goto","selector":"[data-testid=\"rmms-patrol-log-road-report-page\"]"},{"id":"S1","action":"goto"},{"id":"QA-20","action":"goto"}]};
const results = [];
