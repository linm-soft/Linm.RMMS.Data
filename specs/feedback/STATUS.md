...
| demo | `D:/AI-QLBD/Linm.RMMS.Demo/src/demo/features/feedback-demo.html` · native `specs/feedback/ui/prototype/{ios,android}/index.html` `#sc-feedback` · `DES-MOB-FEEDBACK` |
...
| lane | **mobile done** · `/agent-qldb-workflow-mobile` · web Kind B **giữ** |
| ios | `D:/AI-QLBD/Linm.RMMS.Mobile.iOS` |
| android | `D:/AI-QLBD/Linm.RMMS.Mobile.Android` |
| bff | `D:/AI-QLBD/Linm.RMMS.Mobile.Bff` |
| backend | `D:/AI-QLBD/Linm.RMMS.WebService` · **`api/v1/nhan-dan/gop-ys`** (web) · **`api/v1/integration/feedbacks`** (mobile) · DOMAIN-MAP Integration · **cấm ERP.*** |
| domain | **Integration** |
...
- Implement: `specs/feedback/implement/feedback.md` · `implement/ios.md` · `implement/android.md`
