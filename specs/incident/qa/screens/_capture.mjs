...
const cfg = {"url":"http://localhost:9304/su-co","outDir":"D:\\AI-QLBD\\Linm.RMMS.Data\\specs\\incident\\qa\\screens","loginPage":"http://localhost:9100/login","company":"RMMS","headless":false,"pagesWait":null,"testid":"rmms-incident-list-page","steps":[{"id":"S0","action":"goto","selector":"[data-testid=\"rmms-incident-list-page\"]"},{"id":"S1","action":"goto"},{"id":"QA-20","action":"goto"}]};
const results = [];
