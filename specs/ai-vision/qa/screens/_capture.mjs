...
const cfg = {"url":"http://localhost:9301/ai-vision","outDir":"D:\\AI-QLBD\\Linm.RMMS.Data\\specs\\ai-vision\\qa\\screens","loginPage":"http://localhost:9100/login","company":"RMMS","headless":false,"pagesWait":null,"testid":"rmms-ai-vision-list-page","steps":[{"id":"S0","action":"goto","selector":"[data-testid=\"rmms-ai-vision-list-page\"]"},{"id":"S1","action":"goto"},{"id":"QA-20","action":"goto"}]};
const results = [];
