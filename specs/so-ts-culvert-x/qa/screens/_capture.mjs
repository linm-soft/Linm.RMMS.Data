...
const cfg = {"url":"http://localhost:9301/so-ts-culvert-x","outDir":"D:\\AI-QLBD\\Linm.RMMS.Data\\specs\\so-ts-culvert-x\\qa\\screens","loginPage":"http://localhost:9100/login","company":"RMMS","headless":false,"pagesWait":null,"testid":"","steps":[{"id":"S0","action":"goto"},{"id":"S1","action":"goto"},{"id":"QA-20","action":"goto"}]};
const results = [];
