...
| updatedAt | `2026-08-19T18:43:01.280Z` |
## Lock
...
|------|-------|----------|--------|
| 0 | data-analy | _data-analy/patrol-pin-control-hint.md · patrol-pin-bff-endpoints.md · patrol-pin-real-data.md · patrol-pin-action-tree.md | **pending** |
...
| 3 | team-lead | task/patrol-pin.md | **pending** |
| 4 | dev | implement/ios.md · implement/android.md | **pending** |
| 5 | qa | qa/scenarios.md · qa/store/patrol-pin/CAPTURE.md | **pending** |
