...
const aliasUrl = "http://localhost:9301/so-ts-bus-station";
const formUrl = "http://localhost:9301/so-ts/tao-moi?type=BUS_STATION";
const listSel = '[data-testid="rmms-so-ts-bus-station-list-page"]';
const formSel = '[data-testid="rmms-asset-form-shell"]';
const attrSel = '[data-testid="asset-bus-station-attr"]';
...
const steps = [
  {
    ...
    url: listUrl,
    selector: listSel,
    note: "list BUS_STATION profile + filter bar",
  },
  {
    id: "S1",
    url: aliasUrl,
    selector: listSel,
    note: "alias /so-ts-bus-station → type=BUS_STATION",
  },
  {
    id: "QA-20",
    url: formUrl,
    selector: formSel,
    also: attrSel,
    note: "Create form · S-ATTR bus-station",
  },
];
...
const manifest = {
  ...
  testid: "rmms-so-ts-bus-station-list-page",
