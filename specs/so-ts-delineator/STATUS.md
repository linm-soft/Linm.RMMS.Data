...
| updatedAt | `2026-08-31T18:06:40.424Z` |
## Lock
...
|------|-------|----------|--------|
| 0 | data-analy | _data-analy/features/so-ts-delineator-control-hint.md · so-ts-delineator-real-data.md | **pending** |
| 1 | po | po/requirement.md | **pending** |
| 2.1 | design | ui/design.md + prototype + reviewUrl | **pending** |
| 2.2 | sa | be/solution-discovery.md | **pending** |
| 3 | team-lead | task/so-ts-delineator.md | **pending** |
| 4 | dev | implement/so-ts-delineator.md | **pending** |
