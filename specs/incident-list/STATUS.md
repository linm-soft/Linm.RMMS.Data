...
| updatedAt | `2026-08-19T05:23:39.660Z` |
## Lock
...
|------|-------|----------|--------|
| 0 | data-analy | _data-analy/incident-list-control-hint.md · incident-list-bff-endpoints.md · incident-list-action-tree.md | **pending** |
...
| 3 | team-lead | task/incident-list.md | **pending** |
| 4 | dev | implement/ios.md · implement/android.md | **pending** |
| 5 | qa | qa/scenarios.md · qa/store/incident-list/CAPTURE.md | **pending** |
