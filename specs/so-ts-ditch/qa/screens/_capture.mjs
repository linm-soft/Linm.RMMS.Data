...
const aliasUrl = "http://localhost:9301/so-ts-ditch";
const formUrl = "http://localhost:9301/so-ts/tao-moi?type=DITCH";
const listSel = '[data-testid="rmms-so-ts-ditch-list-page"]';
const formSel = '[data-testid="rmms-asset-form-shell"]';
const attrSel = '[data-testid="asset-ditch-attr"]';
...
const steps = [
  {
    ...
    url: listUrl,
    selector: listSel,
    note: "list DITCH profile + filter bar · kmTo ON · primary ditch_type",
  },
  {
    id: "S1",
    url: aliasUrl,
    selector: listSel,
    note: "alias /so-ts-ditch → type=DITCH",
  },
  {
    id: "QA-20",
    url: formUrl,
    selector: formSel,
    also: attrSel,
    note: "Create form · S-ATTR ditch · S-LOC-RANGE · CD-",
  },
];
...
const manifest = {
  ...
  testid: "rmms-so-ts-ditch-list-page",
};
