...
| 5 | Finder + stamps | FOV box · route · GPS stamp (live/session) | **PASS** | A3 / P6 |
| 6 | Detect card | `Ổ gà · Mặt đường` · Hành động · **score ẩn** | **PASS** | A3 / P6 |
| 7 | CTA Confirm / Skip | Primary + Secondary · no UIAlert | **PASS** | A3 / P6 |
| 8 | Dual OS | iOS 6.9" + Android Pixel 1080×1920 | **PASS** | A3 + P6 + P6-2 |
| 9 | Watermark / placeholder | none «Gói N» / «gen realapp» | **PASS** | CORE Read |
| 10 | Sibling AC | only `cam-patrol` · no field-reflect / cam-view | **PASS** | flows |
...
| Camera/GPS privacy declared | A5/A7 | P8 | **PASS** (declared Dev) | STATUS GAP-SA-STORE-01 |
...
| bugs | `qa/bugs/cam-patrol.md` · CLOSED |
...
| generatedAt | `2026-08-28T21:59:16.000Z` |
