...
const cfg = {"url":"http://localhost:9301/csdl-so-05","outDir":"D:\\AI-QLBD\\Linm.RMMS.Data\\specs\\csdl-so-05\\qa\\screens","loginPage":"http://localhost:9100/login","company":"RMMS","headless":false,"pagesWait":null,"testid":"","steps":[{"id":"S0","action":"goto"}]};
const results = [];
