...
const cfg = {"url":"http://localhost:9301/so-ts-retaining","outDir":"D:\\AI-QLBD\\Linm.RMMS.Data\\specs\\so-ts-retaining\\qa\\screens","loginPage":"http://localhost:9100/login","company":"RMMS","headless":false,"pagesWait":null,"testid":"","steps":[{"id":"S0","action":"goto"}]};
const results = [];
