/**
 * E2E capture S0/S1/QA-20 — so-ts-its-camera · channel=chrome · no kill :9301
...
const aliasUrl = "http://localhost:9301/so-ts-its-camera";
...
const steps = [
  {
    ...
    note: "list ITS_CAMERA profile + filter bar · type hidden · TTĐH · thiết bị grid cols",
  },
  {
    id: "S1",
    url: aliasUrl,
    selector: `[data-testid="${TEST_ID}-page"]`,
    note: "alias /so-ts-its-camera → Navigate type=ITS_CAMERA",
  },
  {
    id: "QA-20",
    url: formUrl,
    selector: '[data-testid="rmms-asset-form-shell"]',
    note: "Create form · S-ATTR ITS · S-LOC-POINT kmFrom only · IT-",
  },
];
