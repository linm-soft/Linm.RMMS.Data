...
const cfg = {"url":"http://localhost:9301/so-ts/csdl-so-sach","outDir":"D:\\AI-QLBD\\Linm.RMMS.Data\\specs\\csdl-so-sach\\qa\\screens","pagesWait":null,"testid":"rmms-csdl-so-sach-hub","steps":[{"id":"S0","action":"goto","selector":"[data-testid=\"rmms-csdl-so-sach-hub\"]"},{"id":"S1","action":"goto"},{"id":"QA-20","action":"goto"}]};
const results = [];
