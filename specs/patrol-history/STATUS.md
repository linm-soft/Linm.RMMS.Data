...
| updatedAt | `2026-08-19T18:27:25.144Z` |
## Lock
...
|------|-------|----------|--------|
| 0 | data-analy | _data-analy/patrol-history-control-hint.md · patrol-history-bff-endpoints.md · patrol-history-real-data.md · patrol-history-action-tree.md | **pending** |
...
| 3 | team-lead | task/patrol-history.md | **pending** |
| 4 | dev | implement/ios.md · implement/android.md | **pending** |
| 5 | qa | qa/scenarios.md · qa/store/patrol-history/CAPTURE.md | **pending** |
