...
Chỉnh trang **Tuần đường / tuần kiểm** từ demo mock → list catalog parity (Linm erp-form-context Kind B): shell · toolbar · search work · row menu · View readonly · Create/Edit/Copy form work. Align demo → MFE `Linm.Web.RMMS.Patrol` · BE `Linm.RMMS.WebService` domain **Patrol**.
