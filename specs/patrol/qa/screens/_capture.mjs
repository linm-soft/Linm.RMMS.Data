...
const cfg = {"url":"http://localhost:9304/patrol","outDir":"D:\\AI-QLBD\\Linm.RMMS.Data\\specs\\patrol\\qa\\screens","loginPage":"http://localhost:9100/login","company":"RMMS","headless":false,"pagesWait":null,"testid":"rmms-patrol-list","steps":[{"id":"S0","action":"goto","selector":"[data-testid=\"rmms-patrol-list\"]"},{"id":"S1","action":"goto"},{"id":"QA-20","action":"goto"}]};
const results = [];
