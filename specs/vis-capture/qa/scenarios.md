...
| Maestro Android | **PASS** · dual · section **Ảnh hiện trường** + **Bỏ qua** |
...
| QA-03 | Loc SSOT/live + Acc device · class/sev `—` trước detect | **PASS** |
| QA-04 | GPS gate / deny modal reuse — bootstrap GPS ok trên sim/emulator | **PASS** (live ±5 m) |
| QA-05 | Back → incident-list · iOS leading **Vấn đề** · Android chevron | **PASS** (chrome) |
...
| Flow | Path | Result |
|------|------|--------|
| iOS | `qa/e2e/ios.yaml` | **PASS** · waitForAnimationToEnd sau GPS bootstrap |
...
|----|------|-----------------|
| GAP-MOB-A11Y-VIS-01 | ListRow title «±» / «đã chốt» NFC·NFD — Maestro assert text flake · e2e dùng animation wait | **no** (Should) |
...
- closeout QA: `task_752e74c9` · `/agent-qa-mobile` · e2eQa=ON · VERIFY GATE PASS · store PNG live · at: `2026-08-29T10:25:00.000Z`

---
<!-- Version meta: skillId=agent-qa-mobile skillVersion=2026.08.25.01 schemaVersion=1 workflowVersion=2026.08.29.1 rulesVersion=2026.08.29.5 versionGate=rechecked contentHash=sha256:vis-capture-control-hint-20260829 realDataHash=sha256:vis-capture-real-data-20260829 bffContentHash=sha256:vis-capture-mobile-bff-20260829 actionTreeHash=sha256:vis-capture-action-tree-20260829 -->
