...
const cfg = {"url":"http://localhost:9301/so-ts-weigh-station","outDir":"D:\\AI-QLBD\\Linm.RMMS.Data\\specs\\so-ts-weigh-station\\qa\\screens","loginPage":"http://localhost:9100/login","company":"RMMS","headless":false,"pagesWait":null,"testid":"rmms-so-ts-weigh-station-list","steps":[{"id":"S0","action":"goto","selector":"[data-testid=\"rmms-so-ts-weigh-station-list\"]"},{"id":"S1","action":"goto"},{"id":"QA-20","action":"goto"}]};
const results = [];
