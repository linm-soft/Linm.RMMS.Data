...
const aliasUrl = "http://localhost:9301/so-ts-parking";
const formUrl = "http://localhost:9301/so-ts/tao-moi?type=PARKING";
const listSel = '[data-testid="rmms-so-ts-parking-list-page"]';
const formSel = '[data-testid="rmms-asset-form-shell"]';
const attrSel = '[data-testid="asset-parking-attr"]';
...
const steps = [
  {
    ...
    url: listUrl,
    selector: listSel,
    note: "list PARKING profile + filter bar",
  },
  {
    id: "S1",
    url: aliasUrl,
    selector: listSel,
    note: "alias /so-ts-parking → type=PARKING",
  },
  {
    id: "QA-20",
    url: formUrl,
    selector: formSel,
    also: attrSel,
    note: "Create form · S-ATTR parking",
  },
];
...
const manifest = {
  ...
  testid: "rmms-so-ts-parking-list-page",
