...
| updatedAt | `2026-08-19T05:23:39.645Z` |
## Lock
...
|------|-------|----------|--------|
| 0 | data-analy | _data-analy/incident-create-control-hint.md · incident-create-bff-endpoints.md · incident-create-action-tree.md | **pending** |
...
| 3 | team-lead | task/incident-create.md | **pending** |
| 4 | dev | implement/ios.md · implement/android.md | **pending** |
| 5 | qa | qa/scenarios.md · qa/store/incident-create/CAPTURE.md | **pending** |
