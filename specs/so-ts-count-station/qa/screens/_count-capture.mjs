...
const aliasUrl = "http://localhost:9301/so-ts-count-station";
const formUrl = "http://localhost:9301/so-ts/tao-moi?type=COUNT_STATION";
const listSel = '[data-testid="rmms-so-ts-count-station-list-page"]';
const formSel = '[data-testid="rmms-asset-form-shell"]';
const attrSel = '[data-testid="asset-count-station-attr"]';
...
const steps = [
  {
    ...
    url: listUrl,
    selector: listSel,
    note: "list COUNT_STATION profile + filter bar",
  },
  {
    id: "S1",
    url: aliasUrl,
    selector: listSel,
    note: "alias /so-ts-count-station → type=COUNT_STATION",
  },
  {
    id: "QA-20",
    url: formUrl,
    selector: formSel,
    also: attrSel,
    note: "Create form · S-ATTR count station",
  },
];
...
const manifest = {
  ...
  testid: "rmms-so-ts-count-station-list-page",
  formTestid: "rmms-asset-form-shell",
  attrTestid: "asset-count-station-attr",
};
