...
const cfg = {"url":"http://localhost:9301/so-ts-count-station","outDir":"D:\\AI-QLBD\\Linm.RMMS.Data\\specs\\so-ts-count-station\\qa\\screens","loginPage":"http://localhost:9100/login","company":"RMMS","headless":false,"pagesWait":null,"testid":"rmms-so-ts-count-station-list","steps":[{"id":"S0","action":"goto","selector":"[data-testid=\"rmms-so-ts-count-station-list\"]"}]};
const results = [];
