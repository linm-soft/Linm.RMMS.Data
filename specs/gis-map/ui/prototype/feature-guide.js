...
(function (global) {
  const DOCS = {
    ...
    'asset-hub': {
      title: 'Tài sản — menu con',
      kicker: 'Thu thập · quản lý',
      perms: [
        { code: 'asset.road-assets.read', name: 'Xem / tra cứu', on: true },
        { code: 'asset.road-assets.create', name: 'Thu thập thủ công', on: true },
        { code: 'asset.road-assets.update', name: 'Cập nhật hiện trường', on: true },
        { code: 'asset.road-assets.delete', name: 'Bớt (soft)', on: true },
        { code: 'ai-vision.asset-candidates.confirm', name: 'Camera AI → xác nhận', on: true },
      ],
      intro: [
        'Giống app cũ: Tài sản có menu con — thu thập, cập nhật, xem bản đồ. Hiện đại thêm Camera AI (chụp → người xác nhận vào sổ).',
        'Không tách tab Nhận diện: AI là một lối thu thập trong cùng app Tài sản.',
      ],
      std: 'Guide mobile Tài sản: thu thập / cập nhật / bản đồ (vd. cột km) + ảnh/GPS.',
      bullets: ['Thủ công = thêm loại + Km + ảnh', 'Camera AI = ứng viên → Xác nhận / Bỏ', 'Bớt = ẩn sổ, không xóa hẳn'],
    },
    'asset-collect': {
      title: 'Thu thập tài sản thủ công',
      kicker: 'Thêm',
      perms: [
        { code: 'asset.road-assets.create', name: 'Thêm tài sản', on: true },
      ],
      intro: ['Chọn loại (cột km, biển, cống…) · ghim định vị tự động · ảnh · Thêm. Cùng POST api/v1/asset/road-assets.'],
      std: 'Guide: chọn loại → nhập cột km → Thêm cột km.',
      bullets: ['Loại + lý trình bắt buộc', 'Không gõ tay tọa độ'],
    },
    'asset-adjust': {
      title: 'Cập nhật / bớt tài sản',
      kicker: 'Sửa · bớt',
      perms: [
        { code: 'asset.road-assets.update', name: 'Cập nhật', on: true },
        { code: 'asset.road-assets.delete', name: 'Bớt soft', on: true },
      ],
      intro: ['Danh sách TS trên tuyến. Sửa tình trạng/ảnh. Bớt = modal xác nhận, ẩn khỏi sổ (IsActive=false).'],
      std: 'Guide: chọn tài sản → cập nhật thông tin.',
      bullets: ['Bớt ≠ xóa hẳn', 'Modal in-app — không hộp thoại hệ thống'],
    },
    'asset-ai': {
      title: 'Thu thập bằng camera AI',
      kicker: 'Chụp → ứng viên',
      perms: [
        { code: 'ai-vision.asset-candidates.create', name: 'Gửi ảnh nhận diện TS', on: true },
      ],
      intro: ['Chụp thiết bị/TS mới trên tuyến. Máy đề xuất loại + lý trình. Người xác nhận mới vào sổ.'],
      std: 'Lớp hiện đại trên quy trình thu thập cũ — không thay menu Tài sản.',
      bullets: ['Ảnh + định vị bắt buộc', 'Xác nhận trên màn HITL'],
    },
    supervise: {
      title: 'Giám sát tuần đường',
      kicker: 'Hạt · lịch sử + bản đồ',
      perms: [
        { code: 'patrol.sessions.read', name: 'Xem lịch sử check-in', on: true },
        { code: 'notification.inbox.read', name: 'Thông báo', on: true },
      ],
      intro: ['App cũ Giám sát: lọc lịch sử check-in theo tuyến/ngày và xem trên bản đồ. Gói 1: lối từ Check-in.'],
      std: 'Hạt trưởng giám sát tổ tuần trên list + map.',
      bullets: ['Lọc tuyến · ngày', 'Bản đồ check-in', 'Thông báo'],
    },
    feedback: {
      title: 'Góp ý phần mềm',
      kicker: 'Feedback',
      perms: [{ code: 'integration.feedback.create', name: 'Gửi góp ý', on: true }],
      intro: ['App cũ Góp ý: nêu ý kiến tính năng để kỹ thuật ghi nhận.'],
      std: 'Kênh phản hồi nội bộ — không phải cổng dân.',
      bullets: ['Gửi nội dung'],
    },
    'asset-list': {
      ...
      perms: [
        ...
        { code: 'asset.road-assets.create', name: 'Thu thập (hub)', on: true },
        { code: 'asset.road-assets.update', name: 'Cập nhật (hub)', on: true },
      ],
      intro: ['Tra cứu cầu, cống, biển, hộ lan, cột Km… theo tuyến. Thu thập / bớt nằm ở hub Tài sản — không chôn dưới Bản đồ.'],
      std: 'Danh mục KCHT đường bộ (sổ tài sản) — mã gắn lý trình.',
    ...
    'asset-detail': {
      ...
      intro: ['Mã, loại, tuyến–Km, tọa độ. Sửa từ menu Cập nhật / bớt. Bớt = soft trên hub.'],
      std: 'Hồ sơ tài sản KCHT — đối chiếu sổ sách / biểu mặt đường trên Web.',
      bullets: ['Xem + sửa hiện trường từ hub'],
    },
    'ai-hub': {
    ...
    me: {
      ...
      intro: ['Hồ sơ cán bộ (Cập nhật thông tin), Lưu trữ, Góp ý, camera tuyến, thông báo.'],
      std: 'Định danh theo đơn vị Hạt và tuyến được giao trên hợp đồng.',
      bullets: ['Lưu trữ · Góp ý · camera tuyến · chỉ đạo · cài đặt'],
    },
  };
  ...
  const FORBID = {
    ...
    'asset-hub': ['Xóa hẳn tài sản (chỉ được bớt soft)'],
    'asset-collect': ['Gõ tay tọa độ', 'Thêm khi chưa có định vị'],
    'asset-adjust': ['Xóa hẳn tài sản'],
    'asset-ai': ['Gửi ảnh khi chưa có định vị', 'Đưa vào sổ khi chưa xác nhận'],
    'asset-list': [],
    'asset-detail': ['Xóa hẳn tài sản'],
    supervise: ['Sửa điểm check-in đã lưu'],
    feedback: [],
