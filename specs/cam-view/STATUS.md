...
| updatedAt | `2026-08-19T02:06:23.216Z` |
## Lock
...
|------|-------|----------|--------|
| 0 | data-analy | _data-analy/cam-view-control-hint.md · cam-view-bff-endpoints.md · cam-view-action-tree.md | **pending** |
...
| 3 | team-lead | task/cam-view.md | **pending** |
| 4 | dev | implement/ios.md · implement/android.md | **pending** |
| 5 | qa | qa/scenarios.md · qa/store/cam-view/CAPTURE.md | **pending** |
