...
const aliasUrl = "http://localhost:9301/so-ts-ferry";
const formUrl = "http://localhost:9301/so-ts/tao-moi?type=FERRY";
const listSel = '[data-testid="rmms-so-ts-ferry-list-page"]';
const formSel = '[data-testid="rmms-asset-form-shell"]';
const attrSel = '[data-testid="asset-ferry-attr"]';
...
const steps = [
  {
    ...
    url: listUrl,
    selector: listSel,
    note: "list FERRY profile + filter bar",
  },
  {
    id: "S1",
    url: aliasUrl,
    selector: listSel,
    note: "alias /so-ts-ferry → type=FERRY",
  },
  {
    id: "QA-20",
    url: formUrl,
...
const manifest = {
  ...
  testid: "rmms-so-ts-ferry-list-page",
