...
const cfg = {"url":"http://localhost:9301/csdl-so-09","outDir":"D:\\AI-QLBD\\Linm.RMMS.Data\\specs\\csdl-so-09\\qa\\screens","loginPage":"http://localhost:9100/login","company":"RMMS","headless":false,"pagesWait":null,"testid":"rmms-csdl-so-09-list-page","steps":[{"id":"S0","action":"goto","selector":"[data-testid=\"rmms-csdl-so-09-list-page\"]"}]};
const results = [];
