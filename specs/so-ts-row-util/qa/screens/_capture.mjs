/**
 * E2E capture S0/S1/QA-20 — so-ts-row-util · channel=chrome · no kill :9301
...
const aliasUrl = "http://localhost:9301/so-ts-row-util";
...
const steps = [
  {
    ...
    note: "list ROW_UTIL profile + filter bar · type hidden · CT HTKT/type_work/km cols",
  },
  {
    id: "S1",
    url: aliasUrl,
    selector: `[data-testid="${TEST_ID}-page"]`,
    note: "alias /so-ts-row-util → Navigate type=ROW_UTIL",
  },
  {
    id: "QA-20",
    url: formUrl,
    selector: '[data-testid="rmms-asset-form-shell"]',
    note: "Create form · S-ATTR row-util · S-LOC-RANGE · HT-",
  },
];
