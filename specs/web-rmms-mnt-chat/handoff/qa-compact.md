...
writtenAt: 2026-09-25T23:42:00.000Z
...
## Decisions
- formPattern: Mobile chat WORK-C · phone 430 · LinmChatThread+Composer · N/A Modal · DES-GRID N/A
- Grid/DES-GRID/LinErpListFilterBar: N/A · T-QA-FILTER WAIVE
- mfe: Linm.Web.RMMS.Mobile · mfeStdRoute=/web-rmms-mnt-chat · :9301 reuse
- be: Mobile.Bff :5202 · API :5111 · cấm ERP.*
- e2e: S0 Live chat GET{id}+messages · S1 missingId · QA-20 SH-02 · PNG screens/*.png
- stock yarn e2e-qa: FAIL soft port 5101/5201 → `_capture_mnt_chat.mjs`
- Live: GET WO · GET messages · composer · hasGps=false · peer i-chat on work
...
| threadItems / bubbleTheirs | ChatThread/Bubble | S0 bubbleCount=1 |
| emptyThread | EmptyState | N/A this WO (has msgs) |
| composerInput/Send | TextArea/Button | S0 hasComposer=true |
| missingId / emptyBack | EmptyState | S1 PASS |
| entry.chatIcon | Button/Nav peer | i-chat / action.chat on work |
...
## API / tasks (ids only)
- Live: GET maintenance/work-orders/{id} · GET/POST messages · init-data opt
...
## Full paths
- scenarios: D:/AI-QLBD/Linm.RMMS.Data/specs/web-rmms-mnt-chat/qa/scenarios.md
