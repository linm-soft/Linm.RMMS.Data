...
writtenAt: 2026-09-26T06:35:00.000Z
...
- mfe: D:/AI-QLBD/MFE-Source/Linm.Web.RMMS.Mobile · mfeStdUrl http://localhost:9301/web-rmms-mnt-chat · productRoute /work/chat?id=
- be: D:/AI-QLBD/Linm.RMMS.WebService · Maintenance messages · Mobile.Bff :5202 · cấm ERP.*
- demo: N/A · hash skip · cấm rescan (GAP-DES-DEMO-RESCAN-01)
- Chat: TopBar WO · thread GET · composer POST · entry peer #i-chat
- Thread P1 flat · no parentId · reply P2
- Realtime: re-GET after POST · pull optional · cấm SignalR
- labels: useFormOptions() / work.chat.* · cấm hardcode · cấm Me*
- GPS: none on chat
...
- prototype: D:/AI-QLBD/Linm.RMMS.Data/specs/web-rmms-mnt-chat/ui/prototype/index.html
...
- po: D:/AI-QLBD/Linm.RMMS.Data/specs/web-rmms-mnt-chat/po/requirement.md
