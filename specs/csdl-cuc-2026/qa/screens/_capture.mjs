...
const cfg = {"url":"http://localhost:9301/csdl-cuc-2026","outDir":"D:\\AI-QLBD\\Linm.RMMS.Data\\specs\\csdl-cuc-2026\\qa\\screens","loginPage":"http://localhost:9100/login","company":"RMMS","headless":false,"pagesWait":null,"testid":"","steps":[{"id":"S0","action":"goto"}]};
const results = [];
