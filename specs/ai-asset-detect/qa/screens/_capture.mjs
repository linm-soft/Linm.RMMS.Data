...
const cfg = {"url":"http://localhost:9303/ai-vision/ai-asset-detect","outDir":"D:\\AI-QLBD\\Linm.RMMS.Data\\specs\\ai-asset-detect\\qa\\screens","loginPage":"http://localhost:9100/login","company":"RMMS","headless":true,"pagesWait":null,"testid":"rmms-ai-asset-detect-list","steps":[{"id":"S0","action":"goto","selector":"[data-testid=\"rmms-ai-asset-detect-list\"]"},{"id":"S1","action":"goto"},{"id":"QA-20","action":"goto"}]};
const results = [];
