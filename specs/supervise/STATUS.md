...
| updatedAt | `2026-08-19T05:23:39.650Z` |
## Lock
...
|------|-------|----------|--------|
| 0 | data-analy | _data-analy/supervise-control-hint.md · supervise-bff-endpoints.md · supervise-action-tree.md | **pending** |
...
| 3 | team-lead | task/supervise.md | **pending** |
| 4 | dev | implement/ios.md · implement/android.md | **pending** |
| 5 | qa | qa/scenarios.md · qa/store/supervise/CAPTURE.md | **pending** |
