...
const aliasUrl = "http://localhost:9301/so-ts-bus-stop";
const formUrl = "http://localhost:9301/so-ts/tao-moi?type=BUS_STOP";
const listSel = '[data-testid="rmms-so-ts-bus-stop-list-page"]';
const formSel = '[data-testid="rmms-asset-form-shell"]';
const attrSel = '[data-testid="asset-bus-stop-attr"]';
...
const steps = [
  {
    ...
    url: listUrl,
    selector: listSel,
    note: "list BUS_STOP profile + filter bar",
  },
  {
    id: "S1",
    url: aliasUrl,
    selector: listSel,
    note: "alias /so-ts-bus-stop → type=BUS_STOP",
  },
  {
    id: "QA-20",
    url: formUrl,
    selector: formSel,
    also: attrSel,
    note: "Create form · S-ATTR bus stop",
  },
];
...
const manifest = {
  ...
  testid: "rmms-so-ts-bus-stop-list-page",
  formTestid: "rmms-asset-form-shell",
  attrTestid: "asset-bus-stop-attr",
};
