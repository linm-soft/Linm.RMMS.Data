...
writtenAt: 2026-09-01T03:51:00.000Z
...
- open questions: none
- qa_fail_rollback: Dev Android Appear/fetch · rồi QA re-run
...
| A3-CORE | iOS list | PASS · live rows |
...
## API / tasks (ids only)
- GET `mobile-bff/api/v1/asset/road-assets` — iOS OK · Android **0 call**
- T-QA-01: **fail** · Review pending blocked

## VERIFY
- e2e-qa-mobile: **FAIL** (GAP-QA-STORE-03)
- align Must: Android empty vs iOS rows
- iOS/Android/BFF compile: prior Dev PASS (không re-claim completed)
...
- bugs: specs/asset/qa/bugs/task_4ec34586.md
