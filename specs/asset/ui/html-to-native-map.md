...
| `.search` + `#i-search` · DES-MOB-ASSET-LIST-SEARCH | Search | `LinmSearchField` · `LinmSearchGlyph` | same | placeholder `LinmCopy.t("asset.list.search")` · **cấm** kit default «Tìm» · **GAP-MOB-COPY** |
