...
| implement.artifact | `specs/asset/implement/asset-qa-fix-plan.md` · `ios.md` · `android.md` |
...
| verifyGate | QA e2e **FAIL** `task_0aaf071e` · Dev **plan** `task_ad15226f` · `qa_fix_plan` pending_confirm |
...
| T-BFF-01 | bff | **done** (web BFF) · **reuse** Mobile.Bff proxy · **cấm** AssetListController |
