...
const listUrl = "http://localhost:9301/so-ts?type=INTERCHANGE";
const aliasUrl = "http://localhost:9301/so-ts-interchange";
const formUrl = "http://localhost:9301/so-ts/tao-moi?type=INTERCHANGE";
const listSel = '[data-testid="rmms-so-ts-interchange-list-page"]';
const formSel = '[data-testid="rmms-asset-form-shell"]';
const attrSel = '[data-testid="asset-interchange-attr"]';
...
const steps = [
  {
    ...
    url: listUrl,
    selector: listSel,
    note: "list INTERCHANGE profile + filter bar",
  },
  {
    id: "S1",
    url: aliasUrl,
    selector: listSel,
    note: "alias /so-ts-interchange → type=INTERCHANGE",
  },
  {
    id: "QA-20",
    url: formUrl,
    selector: formSel,
    also: attrSel,
    note: "Create form · S-ATTR interchange",
  },
];
...
const manifest = {
  ...
  testid: "rmms-so-ts-interchange-list-page",
