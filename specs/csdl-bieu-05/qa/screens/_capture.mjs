...
const steps = [
  {
    ...
    url: listUrl,
    selector: listSel,
    note: "list Biểu 05 · filter-bar · empty/grid · peer Sổ TS",
  },
  {
    id: "S1",
    url: hubUrl,
    selector: hubListSel,
    note: "hub deep-link ?resource=ditches → list",
  },
  {
    id: "QA-20",
    url: formUrl,
...
const manifest = {
  url: listUrl,
  method:
    "playwright channel=chrome headless · contract fallback after yarn e2e-qa playwright install hang risk",
