...
writtenAt: 2026-09-26T02:27:00.000Z
contentHash: sha256:bd4aedbcdb3686ca817a32c3f563270adc1d35b1f7bca526be023528a1840d2b

## Decisions
- changeScope: new_page
- formPattern: Mobile list + RO detail (phone max-width 430) · N/A ERP Modal/Slideout · no POST on Giám sát · /erp-form-context labels
- mfe: D:/AI-QLBD/MFE-Source/Linm.Web.RMMS.Mobile · mfeStdUrl http://localhost:9301/web-rmms-supervise
- nativeRoutes: /supervise · /supervise/:id · alias /field/supervise* · DES-MOB-SUPERVISE + DES-MOB-SUP-DETAIL
- be: D:/AI-QLBD/Linm.RMMS.WebService · Mobile.Bff :5202 mobile-bff/api/v1 · Patrol attendance-logs · cấm ERP.*
- demo: N/A · cite #sc-supervise* / #sc-supervise-detail only · cấm demoDays/demo SSOT
- API reuse: GET list + GET/{id} patrol/attendance-logs · day = client CheckInAt · cấm invent /supervise/*
...
- filter: live route + day · cấm toast giả · segment map → /patrol-map
- copy: Android/DES-MOB-SUPERVISE parity · cấm sửa iOS/Android · cấm MFE desktop Field
- open questions: UNCLEAR-DOMAIN-MAP-SUP · UNCLEAR-STD-ROUTE · UNCLEAR-FROMDATE · UNCLEAR-ORG · UNCLEAR-EMPTY-COPY
...
## UNCLEAR
- UNCLEAR-DOMAIN-MAP-SUP: add DOMAIN-MAP row web-rmms-supervise (SA) · slug supervise exists
- UNCLEAR-STD-ROUTE: SCREENS /supervise* vs mfeStdRoute /web-rmms-supervise — follow STATUS
- UNCLEAR-FROMDATE: BE fromDate MISSING — P1 client day · cấm invent
- UNCLEAR-ORG: DTO no OrgUnit — Note/fallback
...
- peer: D:/AI-QLBD/Linm.RMMS.Data/docs/context/features/supervise.md
