...
const cfg = {"url":"http://localhost:9301/web-rmms-supervise","outDir":"D:\\AI-QLBD\\Linm.RMMS.Data\\specs\\web-rmms-supervise\\qa\\screens","loginPage":"http://localhost:9100/login","company":"RMMS","headless":false,"pagesWait":null,"testid":"","steps":[{"id":"S0","action":"goto"},{"id":"S1","action":"goto"},{"id":"QA-20","action":"goto"}]};
const results = [];
