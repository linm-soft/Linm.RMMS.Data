...
const aliasUrl = "http://localhost:9301/so-ts-rest-area";
const formUrl = "http://localhost:9301/so-ts/tao-moi?type=REST_AREA";
const listSel = '[data-testid="rmms-so-ts-rest-area-list-page"]';
const formSel = '[data-testid="rmms-asset-form-shell"]';
const attrSel = '[data-testid="asset-rest-area-attr"]';
...
const steps = [
  {
    ...
    url: listUrl,
    selector: listSel,
    note: "list REST_AREA profile + filter bar",
  },
  {
    id: "S1",
    url: aliasUrl,
    selector: listSel,
    note: "alias /so-ts-rest-area → type=REST_AREA",
  },
  {
    id: "QA-20",
    url: formUrl,
    selector: formSel,
    also: attrSel,
    note: "Create form · S-ATTR rest-area",
  },
];
...
const manifest = {
  ...
  testid: "rmms-so-ts-rest-area-list-page",
