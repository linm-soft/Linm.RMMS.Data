...
const listUrl = "http://localhost:9301/so-ts?type=KM_POST";
const aliasUrl = "http://localhost:9301/so-ts-km-post";
const formUrl = "http://localhost:9301/so-ts/tao-moi?type=KM_POST";
const listSel = '[data-testid="rmms-so-ts-km-post-list-page"]';
const formSel = '[data-testid="rmms-asset-form-shell"]';
const attrSel = '[data-testid="asset-km-post-attr"]';
...
const steps = [
  {
    ...
    url: listUrl,
    selector: listSel,
    note: "list KM_POST profile + filter bar",
  },
  {
    id: "S1",
    url: aliasUrl,
    selector: listSel,
    note: "alias /so-ts-km-post → type=KM_POST",
  },
  {
    id: "QA-20",
    url: formUrl,
    selector: formSel,
    also: attrSel,
    note: "Create form · S-ATTR km-post",
  },
];
...
const manifest = {
  ...
  testid: "rmms-so-ts-km-post-list-page",
